...
Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de la société.
...
Les utilisateurs disposent d'un droit d'accès, de retrait, de modification ou de rectification des données qu'ils ont fournies. Pour cela, il leur suffit d'en faire la demande auprès du directeur de publication (coordonnées dans la rubrique « Contact» du site web).
